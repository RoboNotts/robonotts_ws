...
"""autogenerated by genpy from metrics_refbox_msgs/ReceiveObjectResult.msg. Do not edit."""
import codecs
import sys
...
class ReceiveObjectResult(genpy.Message):
  _md5sum = "9eda82f9b928ca0e6e6c248d42a9d579"
  _type = "metrics_refbox_msgs/ReceiveObjectResult"
...
"""
  ...
  __slots__ = ['message_type','human_pose','human_reach_out_result','pre_grasp_result','grasp_result','post_grasp_result']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       message_type,human_pose,human_reach_out_result,pre_grasp_result,grasp_result,post_grasp_result
    ...
    """
    if args or kwds:
      super(ReceiveObjectResult, self).__init__(*args, **kwds)
      ...
      if self.pre_grasp_result is None:
        self.pre_grasp_result = 0
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_6B().pack(_x.message_type, _x.human_pose, _x.human_reach_out_result, _x.pre_grasp_result, _x.grasp_result, _x.post_grasp_result))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.message_type, _x.human_pose, _x.human_reach_out_result, _x.pre_grasp_result, _x.grasp_result, _x.post_grasp_result,) = _get_struct_6B().unpack(str[start:end])
      return self
