...
class HandoverObjectResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HandoverObjectResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new HandoverObjectResult(null);
...
HandoverObjectResult.Constants = {
  FEEDBACK: 1,
  RESULT: 2,
  HUMAN_POSE_LAYING: 1,
...
module.exports = HandoverObjectResult;
